...
'Created by Steve McMahon http://www.vbaccelerator.com
Option Explicit
...
Sub Main()
    ...
    Case "/Q"
    frmMain.Show
    AlwaysOnTop frmMain.hwnd, False
    frmMain.Hide
    MsgBox "This File Has Been Quarantined By Simple Machine Protect", vbOKOnly
    End
    Case Else
